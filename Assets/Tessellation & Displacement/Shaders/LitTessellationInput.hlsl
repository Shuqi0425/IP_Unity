...
// NOTE: Dots instancing is orthogonal to the constant buffer above.
    ...
    #define _VertexColorBlending                UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _VertexColorBlending)
    #define _VertexColorDispBias                UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _VertexColorDispBias)
    #define _TessellationScale                  UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationScale)
    #define _TessellationFactor                 UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationFactor)
    #define _TessellationFactorMin              UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationFactorMin)
    #define _TessellationFactorMax              UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationFactorMax)
    #define _TessellationDistanceMin            UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationDistanceMin)
    #define _TessellationDistanceMax            UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationDistanceMax)
    #define _TessellationEdgeLength             UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationEdgeLength)
    #define _TessellationEdgeDistanceOffset     UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationEdgeDistanceOffset)
    #define _TessellationPhongShape             UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationPhongShape)
    #define _TessellationTriangleClipBias       UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _TessellationTriangleClipBias)
    #define _HeightStrength                     UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _HeightStrength)
    #define _HeightBase                         UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _HeightBase)
    #define _HeightBlurSize                     UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _HeightBlurSize)
    #define _HeightBlurSamples                  UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _HeightBlurSamples)
    #define _HeightBlurGaussStandardDeviation   UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _HeightBlurGaussStandardDeviation)
    #define _GeometryUVChannel                  UNITY_ACCESS_DOTS_INSTANCED_PROP_WITH_DEFAULT(float , _GeometryUVChannel)
#endif
